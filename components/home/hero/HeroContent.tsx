  ...
  return (
    <div className="space-y-8 text-center lg:text-left">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start flex-wrap gap-4">
        <Link to="/auth" className="group primary-cta inline-flex items-center gap-2 px-6 py-4 rounded-2xl bg-gradient-to-r from-brand-600 to-accent-600 text-white font-semibold shadow-soft hover:shadow-lg transition-all transform hover:-translate-y-1">
          {t('hero.ctaBooking')}
