...
export const authorsData: InternationalizedArticleAuthor[] = [
  {
    ...
    bio: {
      id: "Di dunia dengan janji temu yang impersonal dan perawatan yang terfragmentasi, konsep <strong>\"Apoteker Keluarga\"</strong> yang tepercaya terasa seperti peninggalan masa lalu. Apt. Hanna J. menghidupkan kembali tradisi itu, memadukannya dengan strategi ilmiah paling canggih abad ke-21. Beliau lebih dari sekadar seorang klinisi; beliau adalah mitra yang berdedikasi dan pendukung setia bagi kesehatan keluarga Anda.",
      en: "In a world of impersonal appointments and fragmented care, the concept of a trusted <strong>\"Apoteker Keluarga\"</strong>—a Family Pharmacist—feels like a relic of the past. Apt. Hanna J. is reviving that tradition, blending it with the most advanced scientific strategies of the 21st century. She is more than a clinician; she is a dedicated partner and steadfast advocate for your family’s health."
    },
    fullBio: {
      id: `
<p>Sebagai seorang ibu dari dua anak perempuan, beliau memahami bahwa kesehatan bukanlah konsep abstrak. Ini adalah fondasi di mana keluarga kita dibangun. Ini adalah energi untuk hadir bagi anak-anak kita, kejernihan untuk membimbing mereka, dan vitalitas untuk menikmati hidup yang panjang dan bersemangat bersama mereka. Pemahaman yang sangat pribadi inilah yang menjadi jantung praktiknya. Beliau melihat kliennya bukan sebagai kasus, tetapi sebagai keluarga dengan harapan, ketakutan, dan masa depan yang layak dilindungi.</p>
<p>Selama lebih dari satu dekade, beliau telah mendedikasikan dirinya untuk misi ini, tanpa henti mengejar pengetahuan tidak hanya melalui gelar formalnya tetapi juga melalui pendidikan mandiri berkelanjutan dengan para ahli dan perintis kelas dunia di bidang kedokteran. Ini adalah disiplin yang hidup, terus diasah oleh penelitian mutakhir terbaru untuk memastikan keluarga Anda menerima perawatan yang paling efektif dan cerdas.</p>
<!--SECTION-->
...
<!--SUBSECTION-->
<h4>1. Bagi Mereka yang Menghadapi Penyakit Kronis: Panduan Melewati Badai</h4>
...
<!--SUBSECTION-->
<h4>2. Bagi Mereka yang Mengejar Kesehatan Optimal & Umur Panjang: Arsitek untuk Masa Depan Terbaik Anda</h4>
...
<ul>
  <li><strong>Farmakodinamik:</strong> <em>“Apa yang dilakukan suatu zat terhadap tubuh?”</em> Beliau memetakan efek pastinya, baik terapeutik maupun toksik.</li>
  <li><strong>Farmakokinetik (ADMET):</strong> <em>“Apa yang dilakukan tubuh terhadap suatu zat?”</em> Beliau menelusuri seluruh perjalanannya—<strong>A</strong>bsorpsi, <strong>D</strong>istribusi, <strong>M</strong>etabolisme, <strong>E</strong>kskresi, dan <strong>T</strong>oksisitas. Pemahaman mendalam ini memungkinkannya merancang protokol dengan presisi bedah, memaksimalkan manfaat sambil meminimalkan risiko.</li>
</ul>
<p>Beliau juga seorang ahli dalam menerapkan prinsip <strong>Hormesis</strong>—sebuah fenomena biologis di mana dosis rendah dan terkontrol dari sebuah stresor (seperti puasa terapeutik) membangun ketahanan sistemik, membuat tubuh Anda lebih kuat dan lebih tahan terhadap penyakit.</p>
<!--SECTION-->
<h3>Berpikir Melampaui Batas Kedokteran: Keunggulan Strategisnya</h3>
<p>Keahliannya melampaui penguasaan ilmu-ilmu yang diketahui. Keunggulan strategis terbesarnya terletak pada <strong>pemikiran metadisipliner</strong>—kemampuan untuk melihat sistem kedokteran itu sendiri, memahami kekuatannya, dan melihat keterbatasan inherennya.</p>
<p>Apt. Hanna J. tahu bahwa uji klinis "standar emas", yang dirancang untuk rata-rata statistik, mungkin tidak berlaku untuk individu unik dengan riwayat kompleks dan susunan genetik spesifik. Perspektif ini memberinya kebebasan untuk mengidentifikasi dan mengejar jalan terapeutik yang efektif yang mungkin secara sistematis diabaikan oleh pendekatan yang lebih kaku dan konvensional. Kemampuan untuk berpikir di luar paradigma yang sudah mapan inilah yang memberikan keunggulan strategis utama dalam menyusun rencana yang benar-benar dipersonalisasi untuk Anda.</p>
<!--SECTION-->
...
<ul>
  <li><strong>Bio (Tubuh):</strong> Ditangani dengan seluruh persenjataan ilmiahnya.</li>
  <li><strong>Psiko (Pikiran):</strong> Mengakui hubungan kuat antara pikiran, emosi, dan kesehatan fisik Anda.</li>
  <li><strong>Sosial (Lingkungan):</strong> Memahami dampak keluarga, pekerjaan, dan komunitas terhadap kesejahteraan Anda.</li>
  <li><strong>Spiritual (Tujuan):</strong> Mengambil dari gelar Magister Teologi-nya, beliau menyediakan ruang untuk membahas kebutuhan mendalam manusia akan makna dan harapan—bahan bakar yang menggerakkan setiap perjalanan penyembuhan.</li>
</ul>
<!--SECTION-->
...
<!--SUBSECTION-->
<h4>1. For Those Navigating Chronic Illness: A Guide Through the Storm</h4>
...
<!--SUBSECTION-->
<h4>2. For Those Pursuing Optimal Health & Longevity: An Architect for Your Best Future</h4>
...
<ul>
  <li><strong>Pharmacodynamics:</strong> <em>“What does a substance do to the body?”</em> She maps its precise effects, both therapeutic and toxic.</li>
  <li><strong>Pharmacokinetics (ADMET):</strong> <em>“What does the body do to the substance?”</em> She traces its entire journey—<strong>A</strong>bsorption, <strong>D</strong>istribution, <strong>M</strong>etabolism, <strong>E</strong>xcretion, and <strong>T</strong>oxicity. This profound understanding allows her to design protocols with surgical precision, maximizing benefits while minimizing risks.</li>
</ul>
<p>She is also an expert in applying the principle of <strong>Hormesis</strong>—a biological phenomenon where a low, controlled dose of a stressor (like therapeutic fasting) builds systemic resilience, making your body stronger and more resistant to disease.</p>
<!--SECTION-->
<h3>Thinking Beyond the Boundaries of Medicine: Her Strategic Advantage</h3>
<p>Her expertise extends beyond mastering the known sciences. Her greatest strategic advantage lies in <strong>metadisciplinary thinking</strong>—the ability to look at the system of medicine itself, understand its strengths, and see its inherent limitations.</p>
<p>Apt. Hanna J. knows that a "gold standard" clinical trial, designed for a statistical average, may not apply to a unique individual with a complex history and specific genetic makeup. This perspective gives her the freedom to identify and pursue effective therapeutic avenues that may be systematically overlooked by a more rigid, conventional approach. It is this ability to think outside the established paradigms that provides the ultimate strategic advantage in crafting a plan that is truly personalized to you.</p>
<!--SECTION-->
...
<ul>
  <li><strong>Bio (The Body):</strong> Addressed with her full scientific arsenal.</li>
  <li><strong>Psycho (The Mind):</strong> Recognizing the powerful connection between your thoughts, emotions, and physical health.</li>
  <li><strong>Social (The Environment):</strong> Understanding the impact of your family, work, and community on your well-being.</li>
  <li><strong>Spiritual (The Purpose):</strong> Drawing from her Master's in Theology, she provides a space to address the deep human need for meaning and hope—the fuel that powers every healing journey.</li>
</ul>
<!--SECTION-->
