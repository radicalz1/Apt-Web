...
import { articlesContentData } from './articles/articlesContent.id.ts';
import { articlesViewsData } from './articles/articlesViews.ts';
...
export const articlesData: Article[] = articlesContentData.map(article => {
